...
function dropElement(amount){
    loopSleep(amount, 10, () => {
        ...
        document.querySelector(".result-element-item").textContent = r;
    });
};
...
function dropRare(amount){
    loopSleep(amount, 10, () => {
        ...
        document.querySelector(".result-rare-item").textContent = r;
    });
};
