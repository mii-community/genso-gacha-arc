...
const und_g=[new Element("N","121","Ubu","ウンビウニウム"),new Element("N","122","Ubb","ウンビビウム"),new Element("N","123","Ubt","ウンビトリウム"),new Element("N","124","Ubq","ウンビクアジウム"),new Element("N","125","Ubp","ウンビペンチウム"),new Element("N","126","Ubh","ウンビヘキシウム"),new Element("N","127","Ubs","ウンビセプチウム"),new Element("N","128","Ubo","ウンビオクチウム"),new Element("N","129","Ube","ウンビエンニウム"),new Element("N","130","Utn","ウントリニリウム"),new Element("N","131","Utu","ウントリウニウム"),new Element("N","132","Utb","ウントリビウム"),new Element("N","133","Utt","ウントリトリウム"),new Element("N","134","Utq","ウントリクアジウム"),new Element("N","135","Utp","ウントリペンチウム"),new Element("N","136","Uth","ウントリヘキシウム"),new Element("N","137","Uts","ウントリセプチウム"),new Element("N","138","Uto","ウントリオクチウム")]
const und_f=[new Element("N","139","Ute","ウントリエンニウム"),new Element("N","140","Uqn","ウンクアドニリウム"),new Element("N","141","Uqu","ウンクアドウニウム"),new Element("N","142","Uqb","ウンクアドビウム"),new Element("N","143","Uqt","ウンクアドトリウム"),new Element("N","144","Uqq","ウンクアドクアジウム"),new Element("N","145","Uqp","ウンクアドペンチウム"),new Element("N","146","Uqh","ウンクアドヘキシウム"),new Element("N","147","Uqs","ウンクアドセプチウム"),new Element("N","148","Uqo","ウンクアドオクチウム"),new Element("N","149","Uqe","ウンクアドエンニウム"),new Element("N","150","Upn","ウンペントニリウム"),new Element("N","151","Upu","ウンペントウニウム"),new Element("N","152","Upb","ウンペントビウム")]
const und_d=[new Element("R","153","Upt","ウンペントトリウム"),new Element("R","154","Upq","ウンペンクアジウム"),new Element("R","155","Upp","ウンペントペンチウム"),new Element("R","156","Uph","ウンペントヘキシウム"),new Element("R","157","Ups","ウンペントセプチウム"),new Element("R","158","Upo","ウンペントオクチウム"),new Element("R","159","Upe","ウンペントエンニウム"),new Element("R","160","Uhn","ウンヘキスニリウム"),new Element("R","161","Uhu","ウンヘキスウニウム"),new Element("R","Uhb","162","ウンヘキスビウム")]
const und_p=[new Element("S","163","Uht","ウンヘキストリウム"),new Element("S","164","Uhq","ウンヘキスクアジウム"),new Element("S","165","Uhp","ウンヘキスペンチウム"),new Element("S","165","Uhh","ウンヘキスヘキシウム"),new Element("S","167","Uhs","ウンヘキスセプチウム"),new Element("S","168","Uho","ウンヘキスオクチウム")]
const und_s=[new Element("SS","119","Uue","ウンウンエンニウム"),new Element("SS","120","Ubn","ウンビニリウム")]
...
function dropUnd(amount){
    loopSleep(amount, 10, () => {
        var n=Math.random()*100;
        var r=new Element();
        if(n<0.0001){r=randomFromList(und_s);}     // 1/1000000
        else if(n<0.002){r=randomFromList(und_p);} // 1/50000
        else if(n<20){r=randomFromList(und_d);}    // 1/5
